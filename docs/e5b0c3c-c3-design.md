...
> 本稿含：设计 + 盲预测 + 20 bypass risks 映射（12 调研 + R13 round-1 + R14 round-2 + R15 round-3 + R16 round-4 + R17 round-5 + R18 round-6[6 子类] + R19/R20 round-7[2 子类]）+ 47 测试矩阵 + Codex 问题
...
## 4. bypass risks × 防御映射（12 来自调研 + R13 round-1 + R14 round-2 + R15 round-3 + R16 round-4 + R17 round-5 + R18 round-6 + R19/R20 round-7）
...
## 5. 测试矩阵（47，新文件 `tests/test_deletion_coordinator.py`）
